  ...
  return React.useMemo<string>(() => {
    ...
    const markdownCls: string = cx(
      css({
        ...
        '--yozora-colors-text-error': colors.text.error,
        '--yozora-colors-text-info': colors.text.info,
        '--yozora-colors-text-note': colors.text.note,
        '--yozora-colors-text-success': colors.text.success,
        '--yozora-colors-text-warning': colors.text.warning,
