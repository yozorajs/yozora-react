...
export const defaultTheme: DefaultTheme = {
  yozora: {
    ...
    code: {
      ...
      selectionBackground:
        'var(--md-code-selection-background, hsla(200deg, 30%, 70%, 0.3))',
    },
    codeEmbed: {
      ...
      errorFontFamily:
        'var(--md-code-embed-error-font-family, Consolas, "Source Code Pro", monospace, sans-serif)',
    },
    codeLive: {
      ...
      editorFontFamily:
        'var(--md-code-live-editor-font-family, Consolas, "Source Code Pro", monospace, sans-serif)',
      editorSelectionBackground:
        'var(--md-code-live-editor-selection-background, hsla(200deg, 30%, 70%, 0.3))',
    ...
    inlineCode: {
      ...
      background:
        'var(--md-inline-code-background, hsla(210deg, 13%, 12%, 0.05))',
