/**
 * @see https://github.com/fast-reflexes/better-react-mathjax/blob/6a565eba4c2424c6c1c191a5b55d8a1681d88a02/src/MathJax/MathJax.tsx
 */
import { MathJaxBaseContext } from 'better-react-mathjax'
import React from 'react'

interface MathJaxOverrideableProps {
  ...
  typesettingOptions?: {
    ...
    options?: Omit<Record<string, any>, 'display'>
  }
  renderMode?: 'pre' | 'post'
}
...
const validText = (inputText?: string): boolean =>
  typeof inputText === 'string' && inputText.length > 0

export const MathJax: React.FC<MathJaxProps & React.ComponentPropsWithoutRef<'span'>> = ({
  inline = false,
  hideUntilTypeset,
  onInitTypeset,
  onTypeset,
  ...
  const lastChildren = React.useRef<string>('')
  ...
  const mjPromise = React.useContext(MathJaxBaseContext)
  ...
  const typesetting = React.useRef(false)
   ...
   */
  const effectToUse = typeof window !== 'undefined' ? React.useLayoutEffect : React.useEffect
  effectToUse(() => {
